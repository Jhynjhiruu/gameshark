...
extern chunk_t *D_8079A150; // HeapStart
extern chunk_t *D_8079A154; // HeapEnd

void *func_80785B90(void *str, int c, size_t n) {
    u8 *ptr = str;
    size_t count = 0;
...
void func_80785C30(void *start, void *end) {
    chunk_t *cur;
    chunk_t *temp;
...
void *func_80785CA8(int len) { // malloc
    chunk_t *first;
    chunk_t *next_free;
    chunk_t *temp;
    void *buffer;
    ...
    func_80785B90(buffer, 0, len);
    return buffer;
}

int func_80785D7C(void *ptr) { // free
    chunk_t *chunk_after;
    chunk_t *temp;
    chunk_t *chunk;
